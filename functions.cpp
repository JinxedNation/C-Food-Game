...
void LoadLevels()
{
	...
	//Guy jumping by the tv (1)
	tempP.z = 19200.0;
	tempP.x = -7000.0;
	tempP.y = 10230.0 + 650;
	tempObj.LoadInModel(tempLoader.GetFullVertex(), tempP, tempS, 277, tempC);
	tempY.AddInfo(3, tempObj, 1200.0f, tempP.y, tempP.y - 680.0);
	levels[3].AddAiY(tempY);

	//Guy jumping by the tv (2)
	tempP.z = 21200.0;
	tempP.x = -7840.0;
	tempP.y = 10230.0 + 680;
	tempObj.LoadInModel(tempLoader.GetFullVertex(), tempP, tempS, 277, tempC);
	tempY.AddInfo(3, tempObj, 900.0f, tempP.y, tempP.y - 320.0);
	levels[3].AddAiY(tempY);
	...
	tempP.y = 10230.0;
	tempObj.LoadInModel(tempLoader.GetFullVertex(), tempP, tempS, 277, tempC);
	tempX.AddInfo(2, tempObj, 1300.0f, tempP.x, tempP.x - 6000);
	levels[3].AddAiX(tempX);

	//Guy moving up and down near the coffee shop
	tempLoader.LoadFile("data/models/person.obj");
	tempP.z = 18000.0;
	tempP.x = -915.0;
	tempObj.LoadInModel(tempLoader.GetFullVertex(), tempP, tempS, 277, tempC);
	tempX.AddInfo(2, tempObj, 1300.0f, tempP.x, tempP.x - 4000);
	levels[3].AddAiX(tempX);

	tempP.x = -12150.5;
	tempP.z = 14400.0;
	tempObj.LoadInModel(tempLoader.GetFullVertex(), tempP, tempS, 277, tempC);
	tempX.AddInfo(2, tempObj, 750.0f, tempP.x, tempP.x - 1600);
	levels[3].AddAiX(tempX);
...
{
	CheckAiCollision();
	glBindTexture(GL_TEXTURE_2D, tp.GetTexture(278));
